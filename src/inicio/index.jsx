...
import logo from '../imagenes/logoc.png';
      ...
      return(
        <ul className="prueba">
          {(this.state.conductor)?
            ""
            :
            <li><Link to="/pasajero"><Button variant="outlined" className="button">Client</Button></Link></li>
          }
          <li><Button  outlined className="button" onClick={this.cerrarSesion}>Login</Button></li>                                          
        </ul>
      )
    }else{
      return(
        <ul className="prueba">
          <li><Link to="/registropasajero"><Button ripple className="button" >Client</Button></Link></li>
          <li><Link to="/registroC"><Button ripple className="button">Driver</Button></Link></li>
          <li><Link to="/login" ><Button  outlined className="button" onClick={()=>document.getElementById("menu-btn").checked = false}>Login</Button></Link>               </li>
        </ul>
      )
    }
  }
